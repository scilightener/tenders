...
func NewListMyHandler(svc *tendersvc.Svc, log *slog.Logger) http.HandlerFunc {
	const comp = "handlers.tender.NewListMyHandler"
	...
	return func(w http.ResponseWriter, r *http.Request) {
		...
		tenderDTOs, err := svc.ListMy(r.Context(), lim, off)
