...
func NewNewTenderHandler(svc *tendersvc.Svc, log *slog.Logger) http.HandlerFunc {
	const comp = "handlers.tender.NewNewTenderHandler"
	...
	return func(w http.ResponseWriter, r *http.Request) {
		...
		tndr, err := svc.Save(r.Context(), *req)
